...
export default function FlagNonPayButton({
  policyId,
  email,
  language,
  preview,
}: FlagNonPayButtonProps) {
  ...
  return (
    <div className="flex flex-col items-stretch sm:items-end">
      <button
        ...
        title={
          hasEmail
            ? "Preview and send non-pay alert email"
          ...
          >
            ...
            <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 p-5 border-t border-navy-lighter">
              ...
              <button
                ...
                onClick={handleSend}
                disabled={sending}
                className="px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50"
              >
